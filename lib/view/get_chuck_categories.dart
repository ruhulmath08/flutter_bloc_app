...
import 'package:flutter_bloc_app/blocs/chuck_category_bloc.dart';
...
import 'package:flutter_bloc_app/view/show_chucky_joke.dart';
              ...
              child: InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            ShowChuckyJoke(selectedCategory: categoryList.categories[index],)));
                  },
                  child: SizedBox(
                    height: 65,
                    child: Container(
